...
const Videos = () => {
  ...
  const lectureHandler =(item,index)=>{
    setVideoSrc(item) 
    setIdx(index+1)
  }
  ...
  return (
    <>
    <Stack direction={["column","row"]} maxH={"500vh"} marginTop={"10vh"}>
        <VStack w={"full"}>
          <video src={videoSrc} controls controlsList="nodownload" style={{width:"100%",borderRadius:"30px", marginLeft:"10px"} }></video>


          <VStack alignItems={"flex-start"} p={"8"} w={"full"} overflowY={"auto"} >
          <Heading>Sample Video {idx}</Heading>
          <Text>This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... This is the text about the sample video and it is used for the details of the video... </Text>
          </VStack>
        </VStack>
        <VStack width={["full","xl"]} alignItems={"stretch"} p={"8"} spacing={"8"} overflowY={"auto"} bgColor={"purple.100"} borderRadius={"10px"}>
          {videosArr.map((item,index)=>(
          <Button variant={"ghost"} colorScheme={"purple"} onClick={()=>{setVideoSrc(item); setIdx(index+1)}}>Lecture {index+1}</Button>
